...
class DataAugmentation:
    ...
    def save_notations(self):
        with open(os.path.join('./Data_txt/RoadImages', 'all_label.idl'), 'w') as n:
...
if __name__ == '__main__':
    ...
    new_train_dataset = './Data_txt/RoadImages'
    train_folder = './DATA/'
    notation_file_name = './DATA/label.idl'
    ...
    # new_notation_file_path = os.path.join('./Data_txt/RoadImages', new_notation_file_name)
